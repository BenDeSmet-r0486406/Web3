...
public class Controller extends HttpServlet {
	...
	private String ADDProduct(HttpServletRequest request, HttpServletResponse response) {
		...
		getId(product, request, response, result);
		getDescription(product, request, response, result);
		getPrice(product, request, response, result);
	...
	private void getId(Product product, HttpServletRequest request, HttpServletResponse response, ArrayList<String> result) {
	...
	private void getDescription(Product product, HttpServletRequest request, HttpServletResponse response, ArrayList<String> result) {
	...
	private void getPrice(Product product, HttpServletRequest request, HttpServletResponse response, ArrayList<String> result) {
